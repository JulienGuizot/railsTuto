...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should have picture profile" do
      get :show, :id => @user
      response.should have_selector("h1>img", :class => "gravatar")
    end

    it "should display user's microposts" do
  ...
  describe "POST 'create'" do
    ...
    describe "success" do
      ...
      it "should redirect to new user profile page" do
        post :create, :user => @attr
      ...
      it "should have a welcome message" do
        post :create, :user => @attr
        flash[:success].should =~ /Welcome to Example Application !/i
      end
  ...
  describe "GET 'edit'" do
    ...
    it "should have the good title" do
      get :edit, :id => @user
      response.should have_selector("title", :content => "Profile edit")
    end
  ...
  describe "PUT 'update'" do
    ...
    describe "Echec" do
      ...
      it "should return Edit profile page" do
    ...
    describe "success" do
      ...
      it "should edit user's fields" do
        put :update, :id => @user, :user => @attr
        @user.reload
  ...
  describe "authentification of edit/update page" do

    before(:each) do
      @user = Factory(:user)
    end

    describe "for not identified user" do

      it "should deny access to 'edit' action" do
        get :edit, :id => @user
    ...
    describe "for identified user" do
      ...
      it "should correspond with editing user" do
        get :edit, :id => @user
        response.should redirect_to(root_path)
      end

      it "should correspond with updating user" do
        put :update, :id => @user, :user => {}
        response.should redirect_to(root_path)
      end
    end
  ...
  describe "GET 'index'" do
    ...
    describe "for identified user" do
      ...
      it "dshould have the good title" do
        get :index
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "such as not identified user" do
      it "should deny access" do
    ...
    describe "such as user not admin" do
